...
export function getDaysInYear(now: Date = new Date()) {
...
export function buildYearWidgetModel(now: Date = new Date()): WidgetModel {
...
export function buildGoalWidgetModel(config: AppConfig, now: Date = new Date()): WidgetModel | null {
    const dayOfYear = getCurrentDayOfYear(now);
...
export function getNextMidnight(from: Date = new Date()) {
