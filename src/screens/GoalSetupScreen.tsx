...
// Returns the day-of-year for today (1-based)
...
export default function GoalSetupScreen() {
    ...
    const handleSave = async () => {
        ...
        const newConfig: AppConfig = {
            ...
            goalTitle: title,
            goalDate: selectedDate,
            goalStartDay: getCurrentDayOfYear(), // <-- save the day goal was set
            theme: config?.theme || 'dark',
            accentColor: config?.accentColor || '#fff',
        } as AppConfig;
        ...
        navigation.navigate('WallpaperGenerator', {
            ...
            data: {
                ...
                daysLeft: progress.daysRemaining,
                goalDayOfYear: getGoalDayOfYear(selectedDate),
                goalStartDay: getCurrentDayOfYear(),
            },
        });
    };
                        ...
                        <TouchableOpacity
                            ...
                            onPress={() => navigation.navigate('WallpaperGenerator', {
                                ...
                                data: {
                                    ...
                                    daysLeft,
                                    goalDayOfYear: getGoalDayOfYear(selectedDate),
                                    goalStartDay: config?.goalStartDay ?? getCurrentDayOfYear(),
                                },
                            })}
                        >
                            <Text style={styles.buttonText}>SET AS WALLPAPER</Text>
...
const styles = StyleSheet.create({
    ...
    cancelBtn: {
        marginTop: 16, paddingVertical: 14,
        alignItems: 'center', backgroundColor: 'rgba(255,255,255,0.07)', borderRadius: 14,
    },
    cancelBtnText: { color: '#aaa', fontSize: 14, fontWeight: '600' },
});